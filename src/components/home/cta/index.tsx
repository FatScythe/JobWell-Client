...
const CTA = () => {
  return (
    <section className='my-10 flex flex-col justify-center items-center gap-20 w-full overflow-x-hidden'>
      <header>
        <h3 className='my-2 text-center text-transparent font-bold sm:text-xl bg-clip-text bg-gradient-to-b from-blue-400 to-blue-500'>
